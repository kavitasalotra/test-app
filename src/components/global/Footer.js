      ...
      <div className=" px-6 mx-10  mx-auto">
        <div className="pb-20 border-b">
          <div className="flex flex-wrap -m-8">
            ...
            <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
              <h3 className="mb-6 text-white font-semibold leading-normal">
                Main links
              </h3>
              <ul>
                <li className="mb-3.5">
                ...
                <div className="mb-3 xl:pl-6 inline-block md:max-w-xl w-full overflow-hidden border border-gray-300 rounded-xl focus-within:ring focus-within:ring-indigo-300">
                  <div className="flex flex-wrap items-center">
                    <div className="w-full xl:flex-1">
                      <input
                        className="p-3 xl:p-0 xl:pr-6 w-full bg-transparent font-medium text-gray-500 placeholder-gray-500 outline-none"
                        id="footerInput1-1"
                        type="text"
        ...
        <div className="flex flex-wrap justify-between items-center py-6 -m-4">
          ...
          <div className="w-auto p-4">
            <p className="text-sm text-gray-600 font-medium">
              <span className="font-semibold text-xl tracking-tight">
                <a className="text-3xl text-white font-semibold">
                  <Image
                    className="md:pl-6"
          ...
          <div className="w-auto p-4  ">
            <div className="flex flex-wrap -m-4">
              <div className="w-auto p-4 bg-white border-2 rounded-full border-transparent mr-2">
                <a
              ...
              <div className="w-auto p-4  bg-white border-2 rounded-full border-transparent mr-2">
                <a className="text-blueGray-400 hover:text-indigo-700" href="#">
                  <svg
                    width="16"
                    height="16"
                    viewbox="0 0 16 16"
              ...
              <div className="w-auto p-4  bg-white border-2 rounded-full border-transparent ">
                <a
                  className="text-blueGray-400 hover:text-blueGray-500"
                  href="#"
                >
