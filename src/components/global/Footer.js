...
const Footer = () => {
  return (
    <footer class="bg-white">
      <div class="px-4  pb-2 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
        <div class="pt-12  border-t border-gray-100 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-6">
            ...
            <div class="max-w-md mx-auto mt-8 sm:ml-0">
              ...
              <form class="mt-4">
                <div class="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <button
                    class="block px-8 py-3 font-medium text-white bg-indigo-500 rounded-full transition hover:bg-indigo-600"
                    type="submit"
                  >
                    Subscribe
                  </button>
        ...
        <div class="pt-6 mt-16 border-t border-gray-100 sm:justify-between sm:items-center sm:flex">
          ...
          <ul class="flex justify-center mt-4 gap-6 sm:mt-0 sm:justify-start">
            <li>
              <a
                href="/"
