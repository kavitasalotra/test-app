...
const Footer = () => {
  return (
    <section className=" bg-slate-800 text-left   pt-6 overflow-hidden">
      <div className=" sm:px-6 sm:mx-10  mx-auto">
        ...
        <div className="sm:flex flex-wrap hidden justify-between items-center py-6 -m-4">
          ...
          <div className="w-auto p-4  ">
            <div className="flex flex-wrap -m-4">
              ...
              <div className="w-auto p-4  bg-white border-2 rounded-full border-transparent mr-2">
                <a
                  className="text-blueGray-400 hover:text-blueGray-400"
                  href="#"
                >
                  <svg
                    width="16"
